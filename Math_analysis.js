...
/*
    if (counter === 1) {
        ...
        if (triangle.c[1] <= YW1) console.log('1 >= 2');
        console.log(Y1);
        console.log(pixY);
        if (pixY <= Y1) console.log('3 >= 4');
    }
*/

    //if ((pixY <= Y1) && (triangle.c[1] <= YW1)) if (counter === 1) console.log('LUL');


    if (((pixY >= Y1) && (triangle.c[1] <= YW1)) || ((pixY <= Y1) && (triangle.c[1] >= YW1))) {
        //if (counter === 1) console.log('Y1 false');
        return false;
    }
    ...
    if (((pixY >= Y2) && (triangle.a[1] <= YW2)) || ((pixY <= Y2) && (triangle.a[1] >= YW2))) {
        //if (counter === 1) console.log('Y2 false');
        return false;
    }
    ...
    if (((pixY >= Y3) && (triangle.b[1] <= YW3)) || ((pixY <= Y3) && (triangle.b[1] >= YW3))) {
        //if (counter === 1) console.log('Y3 false');
        return false;
    }
    return true;
